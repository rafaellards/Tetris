function resetGame() {
  // Stop the game if it's currently active
  if (tetris.isActive) {
    tetris.clearTimers();
    tetris.isActive = 0;
  }
  ...
  tetris.board = [];
  tetris.boardDiv = null;
  tetris.canvas = null;
  tetris.curSqs = [];
  tetris.nextShape = null;
  tetris.nextShapeDisplay = null;
  tetris.nextShapeIndex = null;
  tetris.sqs = [];
  tetris.score = 0;
  tetris.scoreDisplay = null;
  tetris.level = 1;
  tetris.levelDisplay = null;
  tetris.time = 0;
  tetris.curComplete = false;
  tetris.timer = null;
  tetris.sTimer = null;
  tetris.speed = 700;
  tetris.lines = 0;
  ...
  (function () {
      ...
      var tetris = {
        ...
        gameOver: function () {
          ...
          var url = "http://localhost/tetris/index.php?nome=&pontos=" +tetris.score+ "&level=" +tetris.level+ "&tempo=" +tetris.time +"&linhas"+tetris.lines;
      ...
      if (controller === "0") {
        ...
        tetris.canvasHeight = 400;
        tetris.canvasWidth = 200;
      } else {
        console.log(controller)
        tetris.canvasHeight = 880;
        tetris.canvasWidth = 440;
      }
...
document.addEventListener("DOMContentLoaded", function () {
  // Define the button elements globally
  const button_1 = document.getElementById('t_1');
  const button_2 = document.getElementById('t_2');
  const reset = document.getElementById('reset');
  const canvas_div = document.getElementById('canvas');
  const tetris_div = document.getElementById('tetris');
  const info_div = document.getElementById('info');
  const controller = document.getElementById('controller');
  const tamanho_h3 = document.getElementById('tamanho_h3');


  // Rest of your code...

  button_1.addEventListener('click', function() {
    // Check if the game is active and stop it
    if (tetris.isActive) {
      tetris.clearTimers();
      tetris.isActive = 0;
    }
    ...
    tamanho_h3.style.display = "none"
    reset.style.display = "block"
    

    tetris_div.style.display = "block";
    // Change the style of the div when the button is clicked
    canvas_div.style.width = '200px';
    canvas_div.style.height = '400px';
    tetris_div.style.width = '360px';
    info_div.style.width = '110px';
    info_div.style.height = '380px';
  ...
  button_2.addEventListener('click', function() {
    ...
    tetris_div.style.display = "block";
    // Change the style of the div when the button is clicked
    canvas_div.style.width = '440px'; // Change to the desired width
    canvas_div.style.height = '880px';
    tetris_div.style.width = '600px';
    info_div.style.width = '110px';
    info_div.style.height = '860px';
